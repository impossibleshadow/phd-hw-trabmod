%% TODO: incluir tabela de unidades (fluxo e tempo)
%% TODO: incluir parâmetros da tese (bom momento para citar)
\documentclass[
...
\begin{center}
    \begin{figure}
      \begin{center}
        \setlength\fboxsep{0pt}
        \setlength\fboxrule{0pt}
        \fbox{\includegraphics[width=0.9\textwidth]{diagramadefluxo}}
